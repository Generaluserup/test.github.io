...
// }
// console.log('Расширение файла : ' + getExt('C:/Users/mikan/Desktop/Test/JS/PZ_1.15.js'))
...
function splitText(str) {
    let vowelsLetters = ['w', 'у', 'е', 'r', 'э', 'и', 'ы', 'я', 'а']
    let result = {
        text: str,
        vowelsLetters: 0,
        consonantsLetters: 0
...
console.log(splitText('Well what is this road to fullstack w'));
...
// }
// console.log(isValidEmail('aarrtt996@gmail.com'))
